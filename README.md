...
- [pilot runbook](docs/pilot-runbook.md) — развёртывание, переменные, jobs, бэкапы, метрики, release gate и smoke-листы;
