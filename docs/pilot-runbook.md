...
5. Проверьте `/bookings`: клиент видит только свои записи в этом бизнесе, может нативно перенести или отменить будущий визит.
6. Откройте payment deep link, нажмите «Я оплатил» и отправьте чек. Чек обязан изменять только выбранный `paymentId`, даже если у клиента несколько ожидающих оплат.
