...
>
> Расхождения с планом: UI-примитивы лежат в `src/features/ui-kit/`, а не в `src/features/ui/`.
...
- [x] **Step 2: Run the test to verify the generated client lacks these fields**
...
- [x] **Step 3: Extend Prisma models and relations**
...
- [x] **Step 4: Generate Prisma Client, apply migration and pass the test**
...
- [x] **Step 1: Write failing tests for valid and invalid domain input**
...
- [x] **Step 3: Implement strict Zod schemas and formatters**
...
- [x] **Step 5: Commit validation and formatting**
...
- [x] **Step 1: Write failing lifecycle and tenant-isolation tests**
...
- [x] **Step 2: Run tests and verify missing-service failures**
...
- [x] **Step 3: Implement one authorization helper and transactional services**
...
- [x] **Step 5: Commit domain services**
...
- [x] **Step 1: Write failing precedence and exception tests**
...
- [x] **Step 2: Run tests and verify the old branch-only behavior fails**
...
- [x] **Step 3: Implement atomic replace operations and availability precedence**
...
- [x] **Step 4: Run schedule and availability tests**
...
- [x] **Step 2: Run test and verify components are missing**

Run: `pnpm vitest run tests/unit/ui/primitives.test.tsx`

Expected: FAIL with unresolved modules.

- [x] **Step 3: Implement semantic primitives and tokenized CSS**
...
- [x] **Step 4: Run UI unit tests and lint**

Run: `pnpm vitest run tests/unit/ui/primitives.test.tsx && pnpm lint`

Expected: PASS.

- [x] **Step 5: Commit UI primitives**
...
- [x] **Step 2: Run tests and verify current mobile settings are absent**
...
- [x] **Step 3: Implement active and responsive navigation**
...
- [x] **Step 4: Run navigation unit/E2E tests**
...
- [x] **Step 1: Write failing page and form tests**
...
- [x] **Step 2: Run targeted tests and verify missing controls**
...
- [x] **Step 3: Implement forms and thin server actions**
...
- [x] **Step 5: Commit branch management**
...
- [x] **Step 1: Write failing form and user-flow tests**
...
- [x] **Step 2: Run tests and verify pages are read-only**
...
- [x] **Step 3: Implement responsive forms and server actions**
...
- [x] **Step 5: Commit entity management**
...
- [x] **Step 1: Write failing editor and onboarding readiness tests**
...
- [x] **Step 2: Run tests and verify the editor is absent**
...
- [x] **Step 3: Implement the editor and real readiness checklist**
...
- [x] **Step 4: Run schedule UI, availability and E2E tests**
...
- [x] **Step 1: Write failing route-state assertions**
...
- [x] **Step 2: Run the full E2E file and capture current missing states**
...
- [x] **Step 3: Implement route states and update the runbook**
...
- [x] **Step 5: Perform manual responsive and accessibility smoke**
...
- [x] **Step 6: Commit wave verification and documentation**
